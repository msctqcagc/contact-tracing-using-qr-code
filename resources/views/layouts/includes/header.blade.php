    ...
    <nav class="navbar navbar-light">
        <div class="navbar-left">
            <a href="#" class="sidebar-toggle">
                <img class="svg" src="" alt="App Logo"></a>
            <a class="navbar-brand" href="{{ route('dashboard') }}"><img class="svg dark" src="" alt=""><img class="light" src="" alt="App Logo Light"></a>
                    ...
                    <ul>
                        <li class="has-subMenu">
                            ...
                            <ul class="subMenu">
                                ...
                                <li>
                                    <a class="active" href="ecommerce.html">Ecommerce</a>
                                </li>
                                <li>
        ...
        <div class="navbar-right">
            <ul class="navbar-right__menu">
                    ...
                    <div class="dropdown-custom">
                        ...
                        <div class="dropdown-wrapper dropdown-wrapper--large">
                            <ul class="list-settings">
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('template/img/mail.png') }}" alt=""></div>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('template/img/color-palette.png') }}" alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('template/img/home.png') }}" alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('template/img/video-camera.png') }}" alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('template/img/document.png') }}" alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                                ...
                                <li class="d-flex">
                                    <div class="mr-3"><img src="{{ asset('template/img/microphone.png') }}" alt=""></div>
                                    <div class="flex-grow-1">
                                        <h6>
                ...
                {{-- <li class="nav-flag-select">
                    <div class="dropdown-custom">
                        <a href="javascript:;" class="nav-item-toggle"><img src="{{ asset('template/img/flag.png') }}" alt="" class="rounded-circle"></a>
                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            <a href="#"><img src="{{ asset('template/img/eng.png') }}" alt=""> English</a>
                            <a href="#"><img src="{{ asset('template/img/ger.png') }}" alt=""> German</a>
                            <a href="#"><img src="{{ asset('template/img/spa.png') }}" alt=""> Spanish</a>
                            <a href="#"><img src="{{ asset('template/img/tur.png') }}" alt=""> Turkish</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-author">
                    <div class="dropdown-custom">
                        <a href="javascript:;" class="nav-item-toggle"><img src="{{ auth()->user()->filePath() }}" alt="" class="rounded-circle"></a>
                        <div class="dropdown-wrapper">
                            <div class="nav-author__info">
                                <div class="author-img">
                                    <img src="{{ auth()->user()->filePath() }}" alt="" class="rounded-circle">
                                </div>
                                <div>
