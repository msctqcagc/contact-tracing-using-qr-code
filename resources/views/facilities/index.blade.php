...
<div class="row">
    <div class="col-lg-12">
        <div class="breadcrumb-main">
            <h4 class="text-capitalize breadcrumb-title">Facilities</h4>
            <div class="breadcrumb-action justify-content-center flex-wrap">
                ...
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalAdd"><i class="la la-plus"></i> Add Facility</a></button>
            </div>
        </div>
    </div>
</div>
